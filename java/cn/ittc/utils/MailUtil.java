...
public class MailUtil {
    ...
    static String from = "平台测试";//发送者,显示的发件人名字
 
    static String user = "jellyjiao5210@sina.com";//发送者邮箱地址
 
    static String password = "wb_jdd5210";//密码
    ...
    public static void main(String args[]) throws UnsupportedEncodingException, InterruptedException
    {
    	for(int i=0;i<100;i++){
    		Thread.sleep(1000*10);
    		 sendEmail("2734698945@qq.com","邮件测试","让你不作为，电话也不接！");//收件人
